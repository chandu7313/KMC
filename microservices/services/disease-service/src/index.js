...
app.get('/health', (req, res) => {
  res.status(200).json({ status: 'healthy', service: 'disease-service', uptime: process.uptime() });
...
const server = app.listen(PORT, '0.0.0.0', () => logger.info(`Disease service running on 0.0.0.0:${PORT}`));
