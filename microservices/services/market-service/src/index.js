...
app.get('/health', (req, res) => res.status(200).json({ status: 'healthy', service: 'market-service', uptime: process.uptime() }));
...
const server = app.listen(PORT, '0.0.0.0', () => logger.info(`Market service running on 0.0.0.0:${PORT}`));
